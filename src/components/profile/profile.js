        ...
        return (
            <div className="children">
                ...
                <ul className="nav nav-tabs">
                    <li className={this.state.boardsorpins==="boards"?"active":""}><a onClick={this.changeTab.bind(null, "boards")}>Boards</a></li>
                    <li className={this.state.boardsorpins==="pins"?"active":""}><a onClick={this.changeTab.bind(null, "pins")}>Pins</a></li>
                </ul>
                </div>
                <br />
